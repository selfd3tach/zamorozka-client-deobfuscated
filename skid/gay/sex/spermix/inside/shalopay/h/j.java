...
public class j implements d {
    ...
    private final Vector b = new Vector(10);
    private String a;

    public j(Class var1) throws NoSuchMethodException {
        this.b(var1);
    }
    ...
    public static d a(Class var0, String var1) throws NoSuchMethodException {
        Constructor var2;
        var2 = a(var0);
        ...
        try {
            ...
            return a(String.valueOf((new StringBuilder()).append("Cannot instantiate test case: ").append(var1).append(" (").append(a(var5)).append(")")));
            ...
            return a(String.valueOf((new StringBuilder()).append("Cannot access test case: ").append(var1).append(" (").append(a(var7)).append(")")));
        }

        return (d) var3;
    }

    public static Constructor a(Class var0) throws NoSuchMethodException {
        try {
    ...
    private void b(Class var1) throws NoSuchMethodException {
        this.a = var1.getName();
    ...
    private void a(Method var1, List var2, Class var3) throws NoSuchMethodException {
