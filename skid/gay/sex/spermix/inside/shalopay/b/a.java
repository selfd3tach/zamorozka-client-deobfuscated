...
public class a {
    ...
    public void b() {
        ...
        if (this.c.j()) {
            this.i = String.valueOf((new StringBuilder(var1.substring(0, 1).toUpperCase())).append(var1.substring(1)));
            ...
            String var3;
            if (this.c.i()) {
                this.h = this.j ? this.c.d().size() * (skid.gay.sex.spermix.inside.shalopay.d.b.b() + 2) + 15 : 15;
                this.i = String.valueOf((new StringBuilder(var1.substring(0, 1).toUpperCase())).append(var1.substring(1)));
                ...
                double var9 = this.e + this.g - skid.gay.sex.spermix.inside.shalopay.d.b.a(this.i) - (double) skid.gay.sex.spermix.inside.shalopay.d.b.a(var3) - 4.0D;
                if (var9 < this.e) {
