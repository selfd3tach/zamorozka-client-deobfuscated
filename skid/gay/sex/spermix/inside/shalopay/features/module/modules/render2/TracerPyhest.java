        ...
        if (this.getState()) {
            ...
            while (var2.hasNext()) {
                ...
                if (var1 instanceof TileEntityChest) {
                    ...
                    var10001 = mc;
                    var14 = var14.rotatePitch(-((float) Math.toRadians(Minecraft.player.rotationPitch)));
                    var10001 = mc;
                    Vec3d var13 = var14.rotateYaw(-((float) Math.toRadians(Minecraft.player.rotationYaw)));
                    GL11.glBegin(2);
                    var10001 = mc;
