      ...
      if (this.c()) {
         ...
         while(var2.hasNext()) {
            ...
            if (var1 != Minecraft.player && var1 != null && var1 instanceof EntityPlayer) {
               ...
               var10001 = mc;
               var16 = var16.rotatePitch(-((float)Math.toRadians((double)Minecraft.player.rotationPitch)));
               var10001 = mc;
               Vec3d var15 = var16.rotateYaw(-((float)Math.toRadians((double)Minecraft.player.rotationYaw)));
               GL11.glBegin(2);
               var10001 = mc;
