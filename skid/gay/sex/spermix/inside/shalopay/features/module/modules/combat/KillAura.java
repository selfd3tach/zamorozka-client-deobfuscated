         ...
         if (var10000 != Minecraft.player.getName()) {
            ...
            if (Main.a.a("Particles").e()) {
               for(int var4 = 1; var4 < 8; ++var4) {
                  mc.world.spawnParticle(EnumParticleTypes.SPIT, var3.posX + Math.sin((double)var4) * 0.1D, var3.posY + 0.1D, var3.posZ + Math.cos((double)var4) * 0.3D, 0.0D, 0.0D, 0.0D, new int[0]);
               }
            }
                           ...
                           if (Main.a.a("Heal").c().equalsIgnoreCase("Enable")) {
                              ...
                              if (Main.a.a("Particles").e()) {
                                 for(int var10 = 1; var10 < 8; ++var10) {
                                    mc.world.spawnParticle(EnumParticleTypes.SPIT, var3.posX + Math.sin((double)var10) * 0.6D, var3.posY + 0.2D, var3.posZ + Math.cos((double)var10) * 0.3D, 0.0D, 0.0D, 0.0D, new int[0]);
                                 }
                              }
