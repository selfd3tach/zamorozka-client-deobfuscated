...
public class HeallLine extends Module {
    public HeallLine() {
        super("HeallLine", 0, ModuleCategory.RENDER2);
    }
    ...
    private void a(Entity var1, double var2, double var4, double var6) {
        ...
        if (((EntityLivingBase) var1).getHealth() <= 20.0F) {
            Gui.drawRect(1.1D, 0.5D, 0.9D, 2.0D, -14880362);
        }

        if (((EntityLivingBase) var1).getHealth() <= 10.0F) {
            Gui.drawRect(1.1D, 0.5D, 0.9D, 2.0D, -196692);
        }

        if (((EntityLivingBase) var1).getHealth() <= 5.0F) {
            Gui.drawRect(1.1D, 0.5D, 0.9D, 2.0D, -63232);
        }
