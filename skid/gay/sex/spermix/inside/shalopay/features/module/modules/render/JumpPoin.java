...
public class JumpPoin extends Module {
    public JumpPoin() {
        super("JumpPoin", 0, ModuleCategory.RENDER);
    }
    ...
    public void onUpdate() {
        ...
        if (this.getState()) {
            ...
            if (mc.gameSettings.keyBindJump.isKeyDown()) {
                if (this.getState()) {
                    for (int var4 = 0; (double) var4 < Main.a.a("Jump").f(); ++var4) {
                        var10000 = mc;
                        ...
                        var10000 = mc;
                        Minecraft.player.addPotionEffect(new PotionEffect(Potion.getPotionById(8), 9999999, var4));
                    }
                } else {
                    var10000 = mc;
                    Minecraft.player.removePotionEffect(Potion.getPotionById(8));
                }
            }
        } else {
            var10000 = mc;
    ...
    public void initModule() {
        Main.a.a(new skid.gay.sex.spermix.inside.shalopay.features.helpers.SettingMode("Jump", this, 3.0D, 0.0D, 7.0D, true));
    }
}
