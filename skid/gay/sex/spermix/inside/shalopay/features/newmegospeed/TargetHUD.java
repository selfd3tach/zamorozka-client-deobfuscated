...
public class TargetHUD extends GuiScreen {
    ...
    public static void b() {
        ...
        new ArrayList();
        boolean var10000;
       var10000 = Minecraft.player.isEntityAlive() && Minecraft.player.isInsideOfMaterial(Material.WATER);
        ...
        if (SmthLikeModuleRegister.a(skid.gay.sex.spermix.inside.shalopay.features.hud.InfoBoard.class).getState()) {
        ...
        if (SmthLikeModuleRegister.a(skid.gay.sex.spermix.inside.shalopay.features.module.modules.world.Scaffold.class).getState()) {
        ...
        if (SmthLikeModuleRegister.a(skid.gay.sex.spermix.inside.shalopay.features.hud.TextRadar.class).getState()) {
        ...
        if (!SmthLikeModuleRegister.a(skid.gay.sex.spermix.inside.shalopay.features.hud.Logo.class).getState()) {
            Main.h.f.a(String.valueOf((new StringBuilder("§3")).append(var21).append("§f").append(var22)), 1.0D, 5.0D, -16739881);
        }
        ...
        if (Main.a.a("InfoBoard").e()) {
            ...
            Gui.drawRect(var0.getScaledWidth() + 600, 250.0D, var0.getScaledWidth() - 160, var0.getScaledWidth() - 50, -2012213232);
            if (Minecraft.player.getHealth() <= 20.0F) {
                Gui.drawRect(var0.getScaledWidth() - 60, 290.0D, var0.getScaledWidth() - 150, 300.0D, -14880362);
            }

            if (Minecraft.player.getHealth() <= 15.0F) {
                Gui.drawRect(var0.getScaledWidth() - 60, 290.0D, var0.getScaledWidth() - 150, 300.0D, -196692);
            }

            if (Minecraft.player.getHealth() <= 10.0F) {
                Gui.drawRect(var0.getScaledWidth() - 60, 290.0D, var0.getScaledWidth() - 150, 300.0D, -20564);
            }

            if (Minecraft.player.getHealth() <= 5.0F) {
                Gui.drawRect(var0.getScaledWidth() - 60, 290.0D, var0.getScaledWidth() - 150, 300.0D, -63232);
            }

            if (Minecraft.player.getHealth() == 0.0F) {
                Gui.drawRect(var0.getScaledWidth() - 60, 290.0D, var0.getScaledWidth() - 150, 300.0D, -2012213232);
            }

            Gui.drawRect(var0.getScaledHeight() + 180, 310.0D, (float) (var0.getScaledWidth() - 78) + Minecraft.player.getFoodStats().getSaturationLevel(), 320.0D, -32172);
        ...
        if (Main.a.a("PlayerBoard").e()) {
            ...
            for (int var25 = 0; var25 < var23.size(); ++var25) {
                if (((EntityPlayer) var23.get(var25)).getName() != Minecraft.player.getName()) {
                    ...
                    if ((double) var16 < Main.a.a("Distance").f() && (SmthLikeModuleRegister.a(skid.gay.sex.spermix.inside.shalopay.features.module.modules.combat.Aura.class).getState() || SmthLikeModuleRegister.a(skid.gay.sex.spermix.inside.shalopay.features.module.modules.combat.KillAura.class).getState() || SmthLikeModuleRegister.a(skid.gay.sex.spermix.inside.shalopay.features.module.modules.combat.JetAura.class).getState() || SmthLikeModuleRegister.a(MatrixAura.class).getState())) {
                        ...
                        Gui.drawRect(var0.getScaledHeight() + 180, 310.0D, (float) (var0.getScaledWidth() - 78) + var26.getFoodStats().getSaturationLevel(), 320.0D, -32172);
    ...
    private static void a(ScaledResolution var0) {
        ...
        if (Main.a.a("RainBow").c().equalsIgnoreCase("Enable")) {
            ...
            int[] var6 = new int[]{2};
            SmthLikeModuleRegister.a().stream().filter(Module::getState).sorted(Comparator.comparingInt((var1x) -> {
                return -var5.getStringWidth(var1x.a());
            })).forEach((var4x) -> {
                if (var4x.a() != "SaveModule") {
            ...
            try {
                ...
                if (Main.a.a("TestArrey").e()) {
                    ...
                    if (Main.a.a("UpArrey").e()) {
                        SmthLikeModuleRegister.a().stream().filter(Module::getState).sorted(Comparator.comparingInt((var0x) -> {
                            return -skid.gay.sex.spermix.inside.shalopay.MobAura.TargetHUD.ClientLoginThread.SmthLikeColorGetter.a(var0x.a());
                        })).forEach((var3x) -> {
                            if (var3x.a() != "SaveModule") {
                                Gui.drawRect((double) (var12 - 2 - skid.gay.sex.spermix.inside.shalopay.MobAura.TargetHUD.ClientLoginThread.SmthLikeColorGetter.a(var3x.a())), var8[0] - 1, (double) (var12 + skid.gay.sex.spermix.inside.shalopay.MobAura.TargetHUD.ClientLoginThread.SmthLikeColorGetter.a(var3x.a())), var8[0] + 6, -2012213232);
                                Gui.drawRect((double) (var12 - 2 - skid.gay.sex.spermix.inside.shalopay.MobAura.TargetHUD.ClientLoginThread.SmthLikeColorGetter.a(var3x.a())), var8[0] + 6, (double) (var12 + skid.gay.sex.spermix.inside.shalopay.MobAura.TargetHUD.ClientLoginThread.SmthLikeColorGetter.a(var3x.a())), var8[0] + 7, -8529921);
                                Gui.drawRect((double) (var12 - 2 - skid.gay.sex.spermix.inside.shalopay.MobAura.TargetHUD.ClientLoginThread.SmthLikeColorGetter.a(var3x.a())), var8[0] - 1, (double) (var12 + skid.gay.sex.spermix.inside.shalopay.MobAura.TargetHUD.ClientLoginThread.SmthLikeColorGetter.a(var3x.a())), var8[0] + 7, -2012213232);
                                char var4 = var3x.a().charAt(0);
                                String var5 = var3x.a().substring(1);
                                skid.gay.sex.spermix.inside.shalopay.MobAura.TargetHUD.ClientLoginThread.SmthLikeColorGetter.a(String.valueOf((new StringBuilder("§3")).append(var4).append("§f").append(var5)), (double) (var12 - 2 - skid.gay.sex.spermix.inside.shalopay.MobAura.TargetHUD.ClientLoginThread.SmthLikeColorGetter.a(var3x.a())), (double) var8[0], 15132410);
        ...
        if (Main.a.a("ArmorStatus").e()) {
            Gui.drawRect(var0.getScaledWidth() - 252, var0.getScaledHeight() - 56, var0.getScaledWidth() - 315, var0.getScaledHeight() - 40, -2012213232);
            ...
            itemRender.renderItemOverlayIntoGUI(Minecraft.getMinecraft().fontRendererObj, Minecraft.player.inventory.armorItemInSlot(0), var0.getScaledWidth() - 270, var0.getScaledHeight() - 56, null);
            ...
            itemRender.renderItemOverlayIntoGUI(Minecraft.getMinecraft().fontRendererObj, Minecraft.player.inventory.armorItemInSlot(1), var0.getScaledWidth() - 285, var0.getScaledHeight() - 56, null);
            ...
            itemRender.renderItemOverlayIntoGUI(Minecraft.getMinecraft().fontRendererObj, Minecraft.player.inventory.armorItemInSlot(2), var0.getScaledWidth() - 300, var0.getScaledHeight() - 56, null);
            ...
            itemRender.renderItemOverlayIntoGUI(Minecraft.getMinecraft().fontRendererObj, Minecraft.player.inventory.armorItemInSlot(3), var0.getScaledWidth() - 315, var0.getScaledHeight() - 56, null);
            GL11.glDisable(2884);
            GL11.glEnable(3008);
            GL11.glDisable(3042);
            GL11.glDisable(2896);
