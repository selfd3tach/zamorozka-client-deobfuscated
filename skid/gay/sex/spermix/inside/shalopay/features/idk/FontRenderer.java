            ...
            if (var15) {
                ...
                for (int var17 = 0; var17 < var16; ++var17) {
                    ...
                    if (var18 == 167 && var17 < var16) {
                        ...
                        GL11.glEnd();
                        if (var13) {
                            this.a(var2, var4 + (TargetHUD.b / 2), var2 + TargetHUD.a - 8.0D, var4 + (TargetHUD.b / 2), 1.0F);
                        }

                        if (var14) {
                            this.a(var2, var4 + TargetHUD.b - 2.0D, var2 + TargetHUD.a - 8.0D, var4 + TargetHUD.b - 2.0D, 1.0F);
                        }

                        var2 += (double) (TargetHUD.a - 8 + this.f);
                    }
                }
