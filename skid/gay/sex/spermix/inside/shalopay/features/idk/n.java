...
public class n {
    ...
    public static void e() {
        try {
            ...
            while (var3.hasNext()) {
                p var2 = (p) var3.next();
                var1.write(String.valueOf((new StringBuilder(var2.a().toLowerCase().replace(" ", ""))).append(":").append(var2.b())));
                var1.write("\r\n");
            }
    ...
    public static void a() {
        try {
            ...
            while (var3.hasNext()) {
                ...
                int var4 = var2.getKeyBind();
                if (var4 <= 114) {
                    var1.write(String.valueOf((new StringBuilder("key-")).append(var2.getName().toLowerCase().replace(" ", "")).append(":").append(Keyboard.getKeyName(var4))));
                    var1.write("\r\n");
                }
            }
    ...
    public static void c() {
        try {
            ...
            while (var3.hasNext()) {
                Module var2 = (Module) var3.next();
                if (var2.getState()) {
                    var1.write(var2.getName().toLowerCase().replace(" ", ""));
                    var1.write("\r\n");
                }
            }
        ...
        try {
            ...
            while ((var5 = var4.readLine()) != null) {
                ...
                while (var11.hasNext()) {
                    ...
                    if (var8.equalsIgnoreCase(String.valueOf((new StringBuilder("key-")).append(var10.getName().toLowerCase().replace(" ", ""))))) {
                        var10.a(var9);
                    }
                }
            }
        ...
        try {
            ...
            while ((var5 = var4.readLine()) != null) {
                ...
                while (var9.hasNext()) {
                    ...
                    if (var8.getName().toLowerCase().replace(" ", "").equals(var7)) {
                        var8.a(true);
                    }
                }
            }
