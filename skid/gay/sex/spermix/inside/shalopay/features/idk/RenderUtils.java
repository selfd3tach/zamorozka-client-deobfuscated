...
public class RenderUtils {
   ...
   public static void b(BlockPos var0) {
      ...
      var1 = (double)var0.getY();
      Minecraft.getMinecraft().getRenderManager();
      double var5 = var1 - RenderManager.renderPosY;
      var1 = (double)var0.getZ();
      Minecraft.getMinecraft().getRenderManager();
   ...
   public static void a(BlockPos var0, Color var1) {
      ...
      var2 = (double)var0.getY();
      Minecraft.getMinecraft().getRenderManager();
      double var6 = var2 - RenderManager.renderPosY;
      var2 = (double)var0.getZ();
      Minecraft.getMinecraft().getRenderManager();
   ...
   public static void a() throws IOException {
      ...
      if (var6.toString().indexOf(Main.d) != -1) {
         a = true;
      } else {
         a = false;
      }
   ...
   public static void a(int var0, int var1, int var2, int var3, ResourceLocation var4) {
      ...
      var6.pos((double)var0, (double)(var1 + var3), 0.0D).tex(0.0D, 1.0D).color(255, 255, 255, 255).endVertex();
      var6.pos((double)(var0 + var2), (double)(var1 + var3), 0.0D).tex(1.0D, 1.0D).color(255, 255, 255, 255).endVertex();
      var6.pos((double)(var0 + var2), (double)var1, 0.0D).tex(1.0D, 0.0D).color(255, 255, 255, 255).endVertex();
      var6.pos((double)var0, (double)var1, 0.0D).tex(0.0D, 0.0D).color(255, 255, 255, 255).endVertex();
      var5.draw();
