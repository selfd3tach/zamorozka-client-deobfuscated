        ...
        if (Main.i()) {
            ...
            try {
                while ((var36 = var35.readLine()) != null) {
                    var33.append((new StringBuilder(var36)).append("\n"));
                }
            ...
            var42 = String.valueOf((new StringBuilder(var17)).append(var41));
            ...
            try {
                ...
                try {
                    ...
                    if (var107 == -1) {
                        ...
                        Main.l = true;
                        Main.a();
                        Main.b(String.valueOf((new StringBuilder(var31)).append(Minecraft.getMinecraft().session.getUsername()).append(":").append(var41)));
                        var0 = true;
                    }
                } finally {
                    if (var106 != null) {
            ...
            String var46 = String.valueOf((new StringBuilder(var17)).append(var41));
            ...
            try {
                ...
                try {
                    var50 = var49.useDelimiter("\\A").next().indexOf(var41);
                    if (var50 == -1) {
                        idk.a();
                        Main.l = false;
                        var0 = false;
